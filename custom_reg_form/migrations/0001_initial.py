    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_letter_text', models.TextField(blank=True, verbose_name=b"Cover Letter", max_length=3000)),
                ('resume_text', models.TextField(blank=True, verbose_name=b"Cover Letter", max_length=3000)),
