    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_letter_text', models.CharField(blank=True, verbose_name=b"Cover Letter", max_length=3000)),
                ('resume_text', models.CharField(blank=True, verbose_name=b"Cover Letter", max_length=3000)),
